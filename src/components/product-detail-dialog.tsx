    ...
    return (
        <React.Fragment>
            <Dialog open={isOpen} onOpenChange={onOpenChange}>
                <DialogContent className="p-0 w-full h-full max-w-full md:max-w-6xl md:h-[85vh] flex flex-col md:flex-row rounded-none md:rounded-lg border-0 top-0 left-0 translate-x-0 translate-y-0 md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 data-[state=open]:animate-in data-[state=open]:zoom-in-90 data-[state=closed]:zoom-out-90 data-[state=closed]:animate-out overflow-hidden bg-[#F8F5F0]">
                    <div className="flex flex-col md:flex-row w-full h-full overflow-hidden">
                        {/* Image Section - Multi-Image Carousel */}
                        <div className="w-full md:w-1/2 relative flex-shrink-0 bg-secondary/20 h-auto md:h-full">
                                ...
                                {item.images && item.images.length > 0 ? (
                                    <Carousel className="w-full h-full group" opts={{ loop: true }}>
                                                ...
                                                <CarouselItem key={index} className="pl-0 h-full relative">
                                                    ...
                                                    >
                                                        <Image
                                                            ...
                                                            className="object-contain md:object-contain object-top md:rounded-l-lg"
                                                            quality={85}
                                                            priority={index === 0}
                                                        />
                                                    </div>
                                        ...
                                        {item.images.length > 1 && (
                                            <>
                                                <CarouselPrevious className="left-2 hidden md:flex opacity-100 bg-background/80 hover:bg-background border-none shadow-md h-10 w-10 text-primary z-20" />
                                                <CarouselNext className="right-2 hidden md:flex opacity-100 bg-background/80 hover:bg-background border-none shadow-md h-10 w-10 text-primary z-20" />
                        ...
                        {/* Details Section */}
                        <div className="w-full md:w-1/2 bg-background md:rounded-r-lg flex flex-col flex-grow min-h-0 relative z-10 md:h-full overflow-y-auto">
                            <div className="p-6 md:p-8 pt-10 md:pt-8 pb-32 md:pb-8">
                                    ...
                                    {item.sizes && item.sizes.length > 0 && (
                                        <div className="mb-8 space-y-3">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="text-xs text-[#3A2A1F]/90 font-medium whitespace-nowrap">Size Guide</span>
                                            </div>
